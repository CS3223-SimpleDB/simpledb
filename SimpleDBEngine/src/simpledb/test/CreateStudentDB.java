   ...
   public static void main(String[] args) {
	  try {
	      ...
	      String createStudentTable = "create table "
	            + "STUDENT(SId int, SName varchar(10), "
	    		+ "MajorId int, GradYear int)";
	      ...
	      String createSectionTable = "create table SECTION(SectId int, "
	            + "CourseId int, Prof varchar(8), YearOffered int)";
	      ...
	      String createEnrollTable = "create table "
